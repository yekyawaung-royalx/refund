...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: "Sender/Receiver Report", href: "#" },
];
...
// --- Main Component ---
export default function FinanceSenderReceiverReport() {
  ...
  const categoryOptions = [
    { label: "All", value: "all" },
    { label: "Sender Pay Prepaid", value: "sender-pay-prepaid" },
    { label: "Receiver Pay Postpaid", value: "receiver-pay-postpaid" }
  ];

  const fetchFiles = async (page: number = 1) => {
    try {
      setLoading(true);
      const res = await fetch(`/finance-report/sender-receiver-report/exported-files?page=${page}`);
  ...
  const handleDownload = (id: number) => {
    window.open(`/finance-report/sender-receiver-report/exported-files/${id}/download`, "_blank");
  };
  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch(`/finance-report/sender-receiver-report/export?${query}`, {
        method: "GET",
      });
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="p-4 space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Finance Report Sender/Receiver Report (
              <span className="text-green-500 font-light">Sender Pay Prepaid</span>,  
              <span className="text-green-500 font-light">Receiver Pay Postpaid</span>)
            </CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Exported Finance COD Refund Reports</CardTitle>
          </CardHeader>
