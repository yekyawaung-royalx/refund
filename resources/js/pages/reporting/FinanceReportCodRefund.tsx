...
// --- Main Component ---
export default function FinanceReportCodRefund() {
  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch(`/finance-report/cod-refund/export?${query}`, {
        method: "GET",
      });
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="p-4 space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Finance Report COD Refund (
              <span className="text-green-500 font-light">Vendor</span>,  
              <span className="text-green-500 font-light">Invoice</span>)
            </CardTitle>
          </CardHeader>
