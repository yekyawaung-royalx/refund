...
// default title using today's date + category label
        ...
        <Card className="rounded-2xl shadow-sm border border-muted">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong className="text-amber-600">No Refund</strong>: a refund needs <span className="text-red-500">to be processed</span>.</li>
              <li><strong className="text-amber-600">Refund</strong>: a refund has <span className="text-green-500">already been processed</span>.</li>
            </ul>
